          ...
          <div className="bg-card rounded-lg border border-border p-8 md:p-12 space-y-8">
            ...
            <section>
              <p className="text-muted-foreground leading-relaxed">
                ShortLink is committed to ensuring digital accessibility for people with disabilities. We are
            ...
            <section>
              ...
              <div className="space-y-3 ml-13 text-muted-foreground">
                <p>
                  ShortLink strives to conform to the Web Content Accessibility Guidelines (WCAG) 2.1, Level AA.
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="p-5 rounded-lg bg-muted/50 border border-border">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Full keyboard navigation support with visible focus indicators. Navigate through all
                    interactive elements using Tab, Enter, and Arrow keys.
                  </p>
                </div>
                ...
                <div className="p-5 rounded-lg bg-muted/50 border border-border">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Semantic HTML and ARIA labels ensure compatibility with screen readers like NVDA, JAWS,
                    and VoiceOver.
                  </p>
                </div>
                ...
                <div className="p-5 rounded-lg bg-muted/50 border border-border">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Mobile-friendly, responsive layout that works across all devices and screen sizes.
                ...
                <div className="p-5 rounded-lg bg-muted/50 border border-border">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Clear, readable fonts with appropriate sizing and line spacing. Text can be resized
                ...
                <div className="p-5 rounded-lg bg-muted/50 border border-border">
                  ...
                  <p className="text-sm text-muted-foreground">
                    All images, icons, and non-text content include descriptive alternative text for
                    screen readers.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-3 text-muted-foreground">
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 ml-4 text-sm">
                    <li><kbd className="px-2 py-1 bg-muted rounded text-xs">Tab</kbd> - Navigate forward through interactive elements</li>
                    <li><kbd className="px-2 py-1 bg-muted rounded text-xs">Shift + Tab</kbd> - Navigate backward</li>
                    <li><kbd className="px-2 py-1 bg-muted rounded text-xs">Enter</kbd> or <kbd className="px-2 py-1 bg-muted rounded text-xs">Space</kbd> - Activate buttons and links</li>
                    <li><kbd className="px-2 py-1 bg-muted rounded text-xs">Esc</kbd> - Close dialogs and modals</li>
                  </ul>
                </div>
                ...
                <div className="pt-3">
                  ...
                  <p className="text-sm">
                    Use <kbd className="px-2 py-1 bg-muted rounded text-xs">Ctrl +</kbd> (Windows) or{" "}
                    <kbd className="px-2 py-1 bg-muted rounded text-xs">Cmd +</kbd> (Mac) to increase text size.
                    Our layout remains functional up to 200% zoom.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="border-t border-border pt-6">
              ...
              <div className="ml-13 text-muted-foreground">
                <p className="mb-3">
                  We welcome your feedback on the accessibility of ShortLink. If you encounter any
                  accessibility barriers or have suggestions for improvement, please let us know:
                </p>
                <ul className="space-y-2">
                  <li>
                    <strong>Email:</strong>{" "}
                    <a href="mailto:accessibility@shortlink.example.com" className="text-primary hover:underline">
                      accessibility@shortlink.example.com
                    </a>
                  </li>
                  <li>
                ...
                <p className="mt-4 text-sm">
                  Your feedback helps us improve accessibility for all users. We appreciate you taking the time
                  to help us create a more inclusive experience.
                </p>
              </div>
            </section>
            ...
            <section className="text-sm text-muted-foreground border-t border-border pt-6">
              <p>
                This accessibility statement was last reviewed on January 2025. We are committed to
                maintaining and improving the accessibility of our website. This statement will be updated
                as we make improvements and receive feedback.
              </p>
            </section>
          </div>
        </div>
