          ...
          <div className="bg-card rounded-lg border border-border p-8 md:p-12 space-y-8">
            ...
            <section>
              <p className="text-muted-foreground leading-relaxed">
                At ShortLink, we take your privacy seriously. This Privacy Policy explains how we collect,
                use, disclose, and safeguard your information when you use our URL shortening service.
            ...
            <section>
              ...
              <div className="space-y-3 ml-13 text-muted-foreground">
                <p>
                  We retain your information for as long as necessary to provide our services and as required
                  by law:
                </p>
                <ul className="list-disc list-inside space-y-1 ml-4">
            ...
            <section>
              ...
              <div className="text-muted-foreground space-y-3">
                <p>
                  ShortLink uses the following third-party services that may collect information:
                </p>
                <ul className="list-disc list-inside space-y-1 ml-4">
                  <li><strong>Supabase:</strong> Database, authentication, and hosting infrastructure</li>
                  <li><strong>Cloudflare:</strong> CDN and edge computing for fast redirects</li>
                </ul>
                <p>
            ...
            <section className="border-t border-border pt-6">
              ...
              <div className="ml-13 text-muted-foreground">
                ...
                <ul className="space-y-1">
                  <li>Email: privacy@shortlink.example.com</li>
