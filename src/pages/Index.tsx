    ...
    return (
        <div className="min-h-screen bg-gradient-subtle">
            <SEO
                ...
                description="Create, manage, and track short URLs with enterprise-grade analytics. Edge-powered redirects with global CDN for instant performance."
                structuredData={{
                    ...
                    potentialAction: {
                        "@type": "SearchAction",
                        target: "https://sl2.my.id/search?q={search_term_string}",
            ...
            <section className="container mx-auto px-4 pt-32 pb-20">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
                        URL Shortener
                        <br />
                        <span className="bg-gradient-primary bg-clip-text text-transparent">Built for Speed</span>
                    </h1>

                    <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">Create, manage, and track short URLs with enterprise-grade analytics. Perfect for marketing campaigns, social media, and branded links.</p>
            ...
            <section className="container mx-auto px-4 py-20 bg-muted/30">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-12">
                        <h2 className="text-4xl font-bold mb-4">Try it now, no signup required</h2>
                        <p className="text-xl text-muted-foreground">Experience the power of ShortLink instantly. Create your first short link in seconds.</p>
                    </div>
            ...
            <section id="features-section" className="container mx-auto px-4 py-20">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-bold mb-4">Everything you need to manage links</h2>
                        <p className="text-xl text-muted-foreground">Powerful features for individuals and teams</p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {features.map((feature, index) => (
                            <div key={index} className="group p-6 rounded-xl bg-card border border-border hover:border-primary/30 transition-all duration-200 hover:shadow-md">
                                <div className="w-12 h-12 rounded-lg bg-gradient-primary flex items-center justify-center text-primary-foreground mb-4 transition-shadow duration-200 group-hover:shadow-md">{feature.icon}</div>
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="space-y-8">
                        {[
                            ...
                            <div key={index} className="group flex gap-6 items-start p-6 rounded-xl bg-card border border-border hover:border-primary/30 transition-all duration-200 hover:shadow-md">
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="relative overflow-hidden rounded-2xl bg-gradient-primary p-12 text-center shadow-lg">
                        <div className="relative z-10">
                            ...
                            <p className="text-xl text-primary-foreground/90 mb-8">Join thousands of users who trust ShortLink for their link management</p>
                            <Link to="/auth">
