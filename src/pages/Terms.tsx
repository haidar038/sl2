...
export default function Terms() {
    return (
        <div className="min-h-screen bg-gradient-subtle">
            <SEO title="Terms of Service" description="Terms of Service for ShortLink. Read our rules and regulations for using our URL shortening service." />
            <Navbar />
                    ...
                    <div className="bg-card rounded-lg border border-border p-8 md:p-12 space-y-8">
                        ...
                        <section>
                            <p className="text-muted-foreground leading-relaxed">
                                Welcome to ShortLink. These Terms of Service ("Terms") govern your access to and use of our URL shortening service. By accessing or using ShortLink, you agree to be bound by these Terms. If you disagree with
                        ...
                        <section>
                            ...
                            <div className="space-y-3 ml-13 text-muted-foreground">
                                <p>
                                    By creating an account or using ShortLink, you acknowledge that you have read, understood, and agree to be bound by these Terms and our Privacy Policy. You also represent that you are at least 13 years
                        ...
                        <section>
                            ...
                            <div className="space-y-3 ml-13 text-muted-foreground">
                                <p>ShortLink provides a URL shortening service that allows you to:</p>
                                ...
                                <p className="mt-4">We reserve the right to modify, suspend, or discontinue any part of the service at any time with or without notice.</p>
                            </div>
                        </section>
                        ...
                        <section>
                            ...
                            <div className="text-muted-foreground space-y-3">
                                <p>To use certain features of ShortLink, you must register for an account. You agree to:</p>
                                <ul className="list-disc list-inside space-y-1 ml-4">
                                ...
                                <p className="mt-4">You may not share your account credentials or allow others to access your account. We reserve the right to suspend or terminate accounts that violate these Terms.</p>
                            </div>
                        </section>
                        ...
                        <section>
                            ...
                            <div className="space-y-3 ml-13">
                                <p className="text-muted-foreground">You agree NOT to use ShortLink for any of the following purposes:</p>
                                <ul className="list-disc list-inside text-muted-foreground space-y-1 ml-4">
                                ...
                                <div className="mt-4 p-4 bg-destructive/10 border border-destructive/20 rounded-lg">
                                    <div className="flex items-start gap-2">
                                        ...
                                        <p className="text-sm text-destructive">
                                            <strong>Warning:</strong> Violation of this policy will result in immediate account suspension or termination. We cooperate with law enforcement agencies and will report illegal activities.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <section>
                            ...
                            <div className="text-muted-foreground space-y-3">
                                <p>You retain all ownership rights to the URLs and content you submit to ShortLink. By using our service, you grant us a limited, worldwide, non-exclusive license to:</p>
                                <ul className="list-disc list-inside space-y-1 ml-4">
                                ...
                                <p className="mt-4">This license terminates when you delete your URLs or close your account, except for anonymized analytics data.</p>
                            </div>
                        </section>
                        ...
                        <section>
                            ...
                            <div className="text-muted-foreground space-y-3">
                                ...
                                <p className="mt-4">We reserve the right to revoke API access for violations or abuse.</p>
                            </div>
                        </section>
                        ...
                        <section>
                            ...
                            <div className="text-muted-foreground space-y-3">
                                <p>ShortLink is provided "as is" and "as available" without warranties of any kind, either express or implied. We do not warrant that:</p>
                                <ul className="list-disc list-inside space-y-1 ml-4">
                                ...
                                <p className="mt-4">You use ShortLink at your own risk. We are not responsible for any damage to your computer system or loss of data resulting from the use of our service.</p>
                            </div>
                        </section>
                        ...
                        <section>
                            ...
                            <div className="text-muted-foreground space-y-3">
                                <p>To the maximum extent permitted by law, ShortLink shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to:</p>
                                <ul className="list-disc list-inside space-y-1 ml-4">
                                ...
                                <p className="mt-4">Our total liability for any claims arising from your use of ShortLink shall not exceed the amount you paid us in the twelve (12) months preceding the claim.</p>
                            </div>
                        </section>
                        ...
                        <section>
                            ...
                            <p className="text-muted-foreground">
                                You agree to indemnify, defend, and hold harmless ShortLink, its officers, directors, employees, and agents from any claims, liabilities, damages, losses, costs, or expenses (including reasonable attorneys'
                                fees) arising from:
                            </p>
                        ...
                        <section>
                            ...
                            <div className="text-muted-foreground space-y-3">
                                <p>We reserve the right to suspend or terminate your account and access to ShortLink at any time, with or without cause, and with or without notice. Reasons for termination may include:</p>
                                <ul className="list-disc list-inside space-y-1 ml-4">
                                ...
                                <p className="mt-4">You may terminate your account at any time through your account settings. Upon termination, your right to use the service will immediately cease.</p>
                            </div>
                        </section>
                        ...
                        <section>
                            ...
                            <p className="text-muted-foreground">
                                We reserve the right to modify these Terms at any time. We will notify users of material changes via email or through our service. Your continued use of ShortLink after such modifications constitutes your
                        ...
                        <section>
                            ...
                            <div className="text-muted-foreground space-y-3">
                                <p>These Terms shall be governed by and construed in accordance with the laws of the jurisdiction in which ShortLink operates, without regard to its conflict of law provisions.</p>
                                <p>
                                    Any disputes arising from these Terms or your use of ShortLink shall first be resolved through good faith negotiations. If negotiations fail, disputes shall be resolved through binding arbitration or in
                        ...
                        <section>
                            ...
                            <div className="text-muted-foreground space-y-2">
                                ...
                                <p>
                                    <strong>Entire Agreement:</strong> These Terms, together with our Privacy Policy, constitute the entire agreement between you and ShortLink regarding the service.
                                </p>
                                <p>
                                    <strong>Assignment:</strong> You may not assign or transfer these Terms without our prior written consent. We may assign our rights without restriction.
                                </p>
                            </div>
                        </section>
